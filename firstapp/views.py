...
#for showing signup/login button for admin(by sidhant)
...
#for showing signup/login button for doctor(by sidhant)
...
#for showing signup/login button for patient(by sidhant)
...
#-----------for checking user is doctor , patient or admin(by sidhant)
def is_admin(user):
